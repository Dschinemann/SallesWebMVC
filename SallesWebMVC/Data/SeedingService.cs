...
namespace SallesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d2 = new Department(2, "Electronic");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");

            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com.br", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(1, "Maria Brown", "maria@gmail.com.br", new DateTime(1999, 5, 22), 1000.0, d2);
            Seller s3 = new Seller(1, "Alex Grey", "alex@gmail.com.br", new DateTime(2000, 6, 25), 1000.0, d3);
            Seller s4 = new Seller(1, "Marta Red ", "marta@gmail.com.br", new DateTime(2001, 8, 1), 1000.0, d4);
            Seller s5 = new Seller(1, "Donal Blue", "donal@gmail.com.br", new DateTime(2003, 11, 4), 1000.0, d2);
            Seller s6 = new Seller(1, "Alex Pink", "alexp@gmail.com.br", new DateTime(20006, 12, 10), 1000.0, d1);
